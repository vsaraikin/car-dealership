    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=10, max_length=2, verbose_name="Supplier's price")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now=True, verbose_name='Time created')),
                ('edited', models.DateTimeField(auto_now=True, verbose_name='Time edited')),
                ('name', models.CharField(max_length=20, verbose_name="Supplier's name")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('discount', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name="Buyer's discount")),
                ('car', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='suppliers.supplier')),
        ...
        migrations.AddField(
            model_name='supplier',
            name='name',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='suppliers.suppliers', verbose_name='Name'),
        ),
    ]
